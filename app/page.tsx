...
export default function Home() {
  ...
  <div className="flex text-2xl mb-6">
    <div className="mr-2">
      <span id="days" className="font-semibold">00</span> Days
    </div>
    <div className="mr-2">
      <span id="hours" className="font-semibold">00</span> Hours
    </div>
    <div className="mr-2">
      <span id="minutes" className="font-semibold">00</span> Minutes
    </div>
    <div>
      <span id="seconds" className="font-semibold">00</span> Seconds
    </div>
  </div>
